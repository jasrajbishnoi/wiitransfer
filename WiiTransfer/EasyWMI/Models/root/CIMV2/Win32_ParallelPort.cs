...
namespace EasyWMI.Models.root.CIMV2
{
    ...
    public class Win32_ParallelPort : WMIBase
    {
        ...
        public bool DMASupport
        {
            get
            {
                return this.m_DMASupport;
            }
            set
            {
                this.m_DMASupport = value;
            }
        }
        ...
        public Int32 SetPowerState(ushort PowerState, string Time)
        {
            ...
            ManagementClass WMIClass = new ManagementClass("Win32_ParallelPort");
