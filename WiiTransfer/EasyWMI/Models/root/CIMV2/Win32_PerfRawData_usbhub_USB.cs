...
namespace EasyWMI.Models.root.CIMV2
{
    ...
    public class Win32_PerfRawData_usbhub_USB : WMIBase
    {
        
        private ulong m_AvgBytesPerTransfer;
        
        private uint m_AvgBytesPerTransfer_Base;
        
        private ulong m_AvgmslatencyforISOtransfers;
        
        private uint m_AvgmslatencyforISOtransfers_Base;
        ...
        public Win32_PerfRawData_usbhub_USB()
        {
        }
        ...
        public uint AvgBytesPerTransfer_Base
        {
            get
            {
                return this.m_AvgBytesPerTransfer_Base;
            }
            set
            {
                this.m_AvgBytesPerTransfer_Base = value;
            }
        }
        ...
        public uint AvgmslatencyforISOtransfers_Base
        {
            get
            {
                return this.m_AvgmslatencyforISOtransfers_Base;
            }
            set
            {
                this.m_AvgmslatencyforISOtransfers_Base = value;
            }
        }
