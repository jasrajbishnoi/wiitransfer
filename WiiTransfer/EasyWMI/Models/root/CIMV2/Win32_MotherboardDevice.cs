...
namespace EasyWMI.Models.root.CIMV2
{
    ...
    public class Win32_MotherboardDevice : WMIBase
    {
        ...
        private string m_PrimaryBusType;
        
        private string m_RevisionNumber;
        
        private string m_SecondaryBusType;
        ...
        public Win32_MotherboardDevice()
        {
        }
        ...
        public string PrimaryBusType
        {
            get
            {
                return this.m_PrimaryBusType;
            }
            set
            {
                this.m_PrimaryBusType = value;
            }
        }
        ...
        public string SecondaryBusType
        {
            get
            {
                return this.m_SecondaryBusType;
            }
            set
            {
                this.m_SecondaryBusType = value;
            }
        }
        ...
        public Int32 SetPowerState(ushort PowerState, string Time)
        {
            ...
            ManagementClass WMIClass = new ManagementClass("Win32_MotherboardDevice");
