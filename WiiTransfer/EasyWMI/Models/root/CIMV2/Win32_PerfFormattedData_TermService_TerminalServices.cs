...
namespace EasyWMI.Models.root.CIMV2
{
    ...
    public class Win32_PerfFormattedData_TermService_TerminalServices : WMIBase
    {
        
        private uint m_ActiveSessions;
        ...
        private uint m_InactiveSessions;
        ...
        private uint m_TotalSessions;
        
        private string m_MyPath;
        
        public Win32_PerfFormattedData_TermService_TerminalServices()
        {
        }
        ...
        public uint ActiveSessions
        {
            get
            {
                return this.m_ActiveSessions;
            }
            set
            {
                this.m_ActiveSessions = value;
            }
        }
        ...
        public uint InactiveSessions
        {
            get
            {
                return this.m_InactiveSessions;
            }
            set
            {
                this.m_InactiveSessions = value;
            }
        }
        ...
        public uint TotalSessions
        {
            get
            {
                return this.m_TotalSessions;
            }
            set
            {
                this.m_TotalSessions = value;
            }
        }
