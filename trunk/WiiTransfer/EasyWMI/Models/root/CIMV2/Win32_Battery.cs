...
namespace EasyWMI.Models.root.CIMV2
{
    ...
    public class Win32_Battery : WMIBase
    {
        
        private ushort m_Availability;
        
        private uint m_BatteryRechargeTime;
        ...
        private uint m_ExpectedBatteryLife;
        ...
        public uint BatteryRechargeTime
        {
            get
            {
                return this.m_BatteryRechargeTime;
            }
            set
            {
                this.m_BatteryRechargeTime = value;
            }
        }
        ...
        public uint ExpectedBatteryLife
        {
            get
            {
                return this.m_ExpectedBatteryLife;
            }
            set
            {
                this.m_ExpectedBatteryLife = value;
            }
        }
