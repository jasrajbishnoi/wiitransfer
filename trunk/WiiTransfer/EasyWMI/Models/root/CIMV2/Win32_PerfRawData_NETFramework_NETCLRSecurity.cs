...
namespace EasyWMI.Models.root.CIMV2
{
    ...
    public class Win32_PerfRawData_NETFramework_NETCLRSecurity : WMIBase
    {
        ...
        private uint m_PercentTimeinRTchecks_Base;
        ...
        public Win32_PerfRawData_NETFramework_NETCLRSecurity()
        {
        }
        ...
        public uint PercentTimeinRTchecks_Base
        {
            get
            {
                return this.m_PercentTimeinRTchecks_Base;
            }
            set
            {
                this.m_PercentTimeinRTchecks_Base = value;
            }
        }
