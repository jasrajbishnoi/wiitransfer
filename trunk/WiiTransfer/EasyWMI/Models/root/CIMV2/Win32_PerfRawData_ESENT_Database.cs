...
namespace EasyWMI.Models.root.CIMV2
{
    ...
    public class Win32_PerfRawData_ESENT_Database : WMIBase
    {
        ...
        private uint m_DatabaseCachePercentHit_Base;
        ...
        public Win32_PerfRawData_ESENT_Database()
        {
        }
        ...
        public uint DatabaseCachePercentHit_Base
        {
            get
            {
                return this.m_DatabaseCachePercentHit_Base;
            }
            set
            {
                this.m_DatabaseCachePercentHit_Base = value;
            }
        }
