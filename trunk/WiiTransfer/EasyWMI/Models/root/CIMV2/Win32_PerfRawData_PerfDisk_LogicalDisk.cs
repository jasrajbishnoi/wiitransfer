...
namespace EasyWMI.Models.root.CIMV2
{
    ...
    public class Win32_PerfRawData_PerfDisk_LogicalDisk : WMIBase
    {
        
        private ulong m_AvgDiskBytesPerRead;
        
        private uint m_AvgDiskBytesPerRead_Base;
        
        private ulong m_AvgDiskBytesPerTransfer;
        
        private uint m_AvgDiskBytesPerTransfer_Base;
        
        private ulong m_AvgDiskBytesPerWrite;
        
        private uint m_AvgDiskBytesPerWrite_Base;
        ...
        private uint m_AvgDisksecPerRead_Base;
        
        private uint m_AvgDisksecPerTransfer;
        
        private uint m_AvgDisksecPerTransfer_Base;
        
        private uint m_AvgDisksecPerWrite;
        
        private uint m_AvgDisksecPerWrite_Base;
        ...
        private uint m_PercentFreeSpace_Base;
        ...
        public Win32_PerfRawData_PerfDisk_LogicalDisk()
        {
        }
        ...
        public uint AvgDiskBytesPerRead_Base
        {
            get
            {
                return this.m_AvgDiskBytesPerRead_Base;
            }
            set
            {
                this.m_AvgDiskBytesPerRead_Base = value;
            }
        }
        ...
        public uint AvgDiskBytesPerTransfer_Base
        {
            get
            {
                return this.m_AvgDiskBytesPerTransfer_Base;
            }
            set
            {
                this.m_AvgDiskBytesPerTransfer_Base = value;
            }
        }
        ...
        public uint AvgDiskBytesPerWrite_Base
        {
            get
            {
                return this.m_AvgDiskBytesPerWrite_Base;
            }
            set
            {
                this.m_AvgDiskBytesPerWrite_Base = value;
            }
        }
        ...
        public uint AvgDisksecPerRead_Base
        {
            get
            {
                return this.m_AvgDisksecPerRead_Base;
            }
            set
            {
                this.m_AvgDisksecPerRead_Base = value;
            }
        }
        ...
        public uint AvgDisksecPerTransfer_Base
        {
            get
            {
                return this.m_AvgDisksecPerTransfer_Base;
            }
            set
            {
                this.m_AvgDisksecPerTransfer_Base = value;
            }
        }
        ...
        public uint AvgDisksecPerWrite_Base
        {
            get
            {
                return this.m_AvgDisksecPerWrite_Base;
            }
            set
            {
                this.m_AvgDisksecPerWrite_Base = value;
            }
        }
        ...
        public uint PercentFreeSpace_Base
        {
            get
            {
                return this.m_PercentFreeSpace_Base;
            }
            set
            {
                this.m_PercentFreeSpace_Base = value;
            }
        }
