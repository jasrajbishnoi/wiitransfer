...
namespace EasyWMI.Models.root.CIMV2
{
    ...
    public class Win32_SoundDevice : WMIBase
    {
        ...
        private ushort m_DMABufferSize;
        ...
        public ushort DMABufferSize
        {
            get
            {
                return this.m_DMABufferSize;
            }
            set
            {
                this.m_DMABufferSize = value;
            }
        }
        ...
        public uint MPU401Address
        {
            get
            {
                return this.m_MPU401Address;
            }
            set
            {
                this.m_MPU401Address = value;
            }
        }
        ...
        public Int32 SetPowerState(ushort PowerState, string Time)
        {
            ...
            ManagementClass WMIClass = new ManagementClass("Win32_SoundDevice");
