...
namespace EasyWMI.Models.root.CIMV2
{
    ...
    public class Win32_PerfRawData_PerfOS_System : WMIBase
    {
        ...
        private uint m_PercentRegistryQuotaInUse_Base;
        ...
        public Win32_PerfRawData_PerfOS_System()
        {
        }
        ...
        public uint PercentRegistryQuotaInUse_Base
        {
            get
            {
                return this.m_PercentRegistryQuotaInUse_Base;
            }
            set
            {
                this.m_PercentRegistryQuotaInUse_Base = value;
            }
        }
