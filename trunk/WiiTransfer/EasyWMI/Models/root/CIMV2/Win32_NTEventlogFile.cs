...
namespace EasyWMI.Models.root.CIMV2
{
    ...
    public class Win32_NTEventlogFile : WMIBase
    {
        ...
        private uint m_MaxFileSize;
        
        private string m_Name;
        
        private uint m_NumberOfRecords;
        
        private uint m_OverwriteOutDated;
        ...
        public uint NumberOfRecords
        {
            get
            {
                return this.m_NumberOfRecords;
            }
            set
            {
                this.m_NumberOfRecords = value;
            }
        }
        
        public uint OverwriteOutDated
        {
            get
            {
                return this.m_OverwriteOutDated;
            }
            set
            {
                this.m_OverwriteOutDated = value;
            }
        }
        ...
        public string OverWritePolicy
        {
            get
            {
                return this.m_OverWritePolicy;
            }
            set
            {
                this.m_OverWritePolicy = value;
            }
        }
        ...
        public Int32 ChangeSecurityPermissions(uint Option, object SecurityDescriptor)
        {
            System.Management.InvokeMethodOptions Options = new System.Management.InvokeMethodOptions();
            Options.Timeout = new TimeSpan(0, 0, 10);
            ManagementClass WMIClass = new ManagementClass("Win32_NTEventlogFile");
...
InParams["Permissions"] = Permissions;
        ...
        public Int32 ClearEventlog(string ArchiveFileName)
        {
            System.Management.InvokeMethodOptions Options = new System.Management.InvokeMethodOptions();
            Options.Timeout = new TimeSpan(0, 0, 10);
            ManagementClass WMIClass = new ManagementClass("Win32_NTEventlogFile");
            ManagementBaseObject InParams = WMIClass.GetMethodParameters("ClearEventlog");
InParams["ArchiveFileName"] = ArchiveFileName;

            ManagementBaseObject OutParams = null;
            OutParams = InvokeMethod(m_MyPath, "ClearEventlog", InParams, Options);

            Int32 numericResult = Convert.ToInt32(OutParams["ReturnValue"]);
            return numericResult;
        }
        
        public Int32 BackupEventlog(string ArchiveFileName)
        {
            System.Management.InvokeMethodOptions Options = new System.Management.InvokeMethodOptions();
            Options.Timeout = new TimeSpan(0, 0, 10);
            ManagementClass WMIClass = new ManagementClass("Win32_NTEventlogFile");
            ManagementBaseObject InParams = WMIClass.GetMethodParameters("BackupEventlog");
InParams["ArchiveFileName"] = ArchiveFileName;

            ManagementBaseObject OutParams = null;
            OutParams = InvokeMethod(m_MyPath, "BackupEventlog", InParams, Options);
