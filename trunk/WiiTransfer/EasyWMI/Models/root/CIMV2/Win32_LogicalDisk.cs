...
namespace EasyWMI.Models.root.CIMV2
{
    ...
    public class Win32_LogicalDisk : WMIBase
    {
        ...
        public bool VolumeDirty
        {
            get
            {
                return this.m_VolumeDirty;
            }
            set
            {
                this.m_VolumeDirty = value;
            }
        }
        ...
        public Int32 ExcludeFromAutochk(string [] LogicalDisk)
        {
            System.Management.InvokeMethodOptions Options = new System.Management.InvokeMethodOptions();
            Options.Timeout = new TimeSpan(0, 0, 10);
            ManagementClass WMIClass = new ManagementClass("Win32_LogicalDisk");
