...
namespace EasyWMI.Controllers.root.CIMV2
{
    ...
    public class Perf : WMIBase, IWMIObject<Win32_Perf>
    {
        ...
        public Perf(string ComputerName) : 
                base(ComputerName)
        {
        }
        
        public Perf(System.Net.IPAddress IPAddress) : 
                base(IPAddress)
        {
        }
        
        public Perf(string Username, string Password, string ComputerName) : 
                base(Username, Password, ComputerName)
        {
        }
        
        public Perf(string Username, string Password, System.Net.IPAddress IPAddress) : 
