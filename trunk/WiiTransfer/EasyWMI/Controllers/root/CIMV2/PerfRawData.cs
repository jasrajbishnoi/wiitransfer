...
namespace EasyWMI.Controllers.root.CIMV2
{
    ...
    public class PerfRawData : WMIBase, IWMIObject<Win32_PerfRawData>
    {
        ...
        public PerfRawData(string ComputerName) : 
                base(ComputerName)
        {
        }
        
        public PerfRawData(System.Net.IPAddress IPAddress) : 
                base(IPAddress)
        {
        }
        
        public PerfRawData(string Username, string Password, string ComputerName) : 
                base(Username, Password, ComputerName)
        {
        }
        
        public PerfRawData(string Username, string Password, System.Net.IPAddress IPAddress) : 
